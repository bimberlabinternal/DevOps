...
if [ ! -e $LK_CONFIG ];then
	...
	wget -O ${LK_CONFIG}/base.application.properties https://github.com/bimberlabinternal/DevOps/raw/master/servers/mcc/config/application.properties

	wget -O $LK_CONFIG/labkey_server.env https://github.com/bimberlabinternal/DevOps/raw/master/servers/mcc/config/labkey_server.env
	wget -O $LK_CONFIG/labkeyServerStartup.sh https://github.com/bimberlabinternal/DevOps/raw/master/servers/mcc/config/labkeyServerStartup.sh
